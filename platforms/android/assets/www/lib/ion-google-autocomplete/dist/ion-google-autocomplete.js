    ...
    return {
        ...
        link: function($scope, element) {
            ...
            var template = [
                ...
                '<input type="search" ng-model="search.query" placeholder="Enter address name">',
                '</label>',
                '<button class="ion-autocomplete-cancel button button-clear button-dark ng-binding" ng-click="close()" translate>Close</button>',
                '</ion-header-bar>',
                '<ion-content>',
                '<ion-list>',
