! function() {
    ...
    function n() {
        return {
            ...
            link: function(n, i, a) {
                function o(i, a) {
                    0 !== n.minRating && i < n.minRating ? n.rating = n.minRating : n.rating = i, n.prevRating = i, a && n.ratingsObj.callback(n.rating, n.index)
                }
                n.iconOn = n.ratingsObj.iconOn || "ion-ios-star", n.iconOff = n.ratingsObj.iconOff || "ion-ios-star-outline", n.iconOnColor = n.ratingsObj.iconOnColor || "rgb(200, 200, 100)", n.iconOffColor = n.ratingsObj.iconOffColor || "rgb(200, 100, 100)", n.rating = n.ratingsObj.rating || 0, n.minRating = n.ratingsObj.minRating || 0, n.readOnly = n.ratingsObj.readOnly || !1, n.index = n.index || 0, n.iconOnColor = {
                    color: n.iconOnColor
                }, n.iconOffColor = {
                    color: n.iconOffColor
                }, n.rating = n.rating > n.minRating ? n.rating : n.minRating, n.prevRating = 0, n.$watch("ratingsObj.rating", function(n, i) {
                    o(n)
                }), n.ratingsClicked = function(n) {
                    o(n, !0)
                }, n.ratingsUnClicked = function(i) {
                    0 !== n.minRating && i < n.minRating ? n.rating = n.minRating : n.rating = i, n.prevRating == i && (0 !== n.minRating ? n.rating = n.minRating : n.rating = 0), n.prevRating = i, n.ratingsObj.callback(n.rating, n.index)
                }
            }
        }
    }
    angular.module("ionic-ratings1", ["ionic"]).directive("ionicRatings1", n)
}();